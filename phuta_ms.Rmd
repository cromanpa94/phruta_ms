...
```{r tw, echo = FALSE}
kbl(sqs.curated$AccessionTable, longtable = TRUE, booktabs = TRUE, caption = "Accession numbers for the retrieved sequences. This dataset has been curated.", format = "latex") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
...
```{r tw2, echo = FALSE}
kbl(sqs.curated$Taxonomy, longtable = TRUE, booktabs = TRUE, caption = "Taxonomic information for the retrieved species", format = "latex") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
...
```{r tw3, echo = FALSE}
kbl(sqs.curated$Taxonomy.Sampling, longtable = TRUE, booktabs = TRUE, caption = "Taxonomic sampling across gene regions", format = "latex") %>%
  kable_styling(latex_options = c("hold_position", "repeat_header"))
```
